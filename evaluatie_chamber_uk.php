...
<title>Evaluation summer school "Play Chamber Music with the Kinksy Trio Prague & Friends"</title>
...
<div id="main">
	<!-- InstanceBeginEditable name="EditRegion1" -->
      <table id="evaluatie">
        <tr>
          <td><h2>Evaluation &quot;Play Chamber Music with the Kinksy Trio Prague & Friends&quot; </h2>
...
<p class="standaard">
   <textarea name="Publiciteit_tx" cols="70" rows="3" id="Publiciteit_tx"></textarea>
              ...
              <table>
                <tr>
                  <td width="491"><label>
                      ...
                      7 days without free day<span class="nadruk"> (like this year)</span></label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="duur" value="8">
                      8 days without free day</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="duur" value="9">
                      9 days without free day</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">This year the course took place in Bechyně instead of České Budějovice. I consider the most suitable course venue:</p>
              <table>
                <tr>
                  <td width="491"><label>
                    <input type="hidden" name="plaats" value="">
                    <input type="radio" name="plaats" value="BE">
                    Bechyně, monastery</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="plaats" value="CB">
                  České Budějovice, conservatoire</label></td>
                </tr>
                <tr>
              ...
              <p>Remarks about the course venue:</p>
              <p>
              ...
              <table>
                ...
                <tr>
                  <td><label>
                      ...
                      the way of  tuition </label>
                    (please explain below)</td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="belangrijk" value="4">
                      the level of the participants</label>
                    (please explain below)</td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">The coaching (with or without playing tutor) of the chamber music I consider:</p>
              <table width="200">
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">The choice to include workshops in the program I consider:</p>
              <table width="200">
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">The workshops in which I took part
                I consider:</p>
              <table width="200">
                <tr>
                  <td><label>
              ...
              <p>The following can be improved (please also mention any ideas for the future):</p>
              <p>
...
<p class="vraag_enquete">The classrooms and the instruments at the monastery I consider:</p>
              ...
              <div class="vraag">
              	<p class="vraag_enquete">This year, there were opportunities on a limited scale to take individual lessons from the teachers. I found this:</p>
              	<table width="342">
              		<tr>
              			<td width="334"><label>
              ...
              <p class="vraag_enquete">I consider the functioning of pianist Veronika Böhmová:</p>
              <table>
                 <tr>
                  <td><label><input name="Boehmova" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>
                <textarea name="Boehmova_tx" cols="70" rows="3" id="Boehmova_tx"></textarea>
					...
					<div class="onzichtbaar">
						<p class="vraag_enquete">I consider the functioning of cellist Jiří Šlechta:</p>
						<table>
							<tr>
								<td><input name="Slechta" type="radio" value="0" checked>
									no opinion </td>
							</tr>
							<tr>
								<td><label>
									<input type="radio" name="Slechta" value="5">
									excellent</label></td>
							</tr>
							<tr>
								<td><label>
									<input type="radio" name="Slechta" value="4">
									good</label></td>
							</tr>
							<tr>
								<td><label>
									<input type="radio" name="Slechta" value="3">
									adequate</label></td>
							</tr>
							<tr>
								<td><label>
									<input type="radio" name="Slechta" value="2">
								weak</label></td>
							</tr>
							<tr>
								<td><label>
									<input type="radio" name="Slechta" value="1">
									inadequate</label></td>
							</tr>
						</table>
						<p>Remarks:</p>
						<p>
							<textarea name="Slechta_tx" cols="70" rows="3" id="Slechta_tx"></textarea>
						</p>
					</div>
					<p class="vraag_enquete">I consider the functioning of cellist Štěpán Doležal:</p>
					<table>
						<tr>
							<td><label><input name="Dolezal" type="radio" value="0" checked>
								no opinion</label> </td>
						</tr>
						<tr>
							<td><label>
              ...
              <p class="vraag_enquete">I consider the functioning of violinist Jakub Fišer</p>
              <table>
                <tr>
                  <td><label><input name="Fiser" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
...
<p class="vraag_enquete">I consider the functioning of clarinettist Dirkjan Horringa:</p>
					<table>
						<tr>
							<td><label><input name="Horringa_chamber" type="radio" value="0" checked>
								no opinion</label> </td>
							</tr>
						<tr>
							<td><label>
					...
					<p>Remarks:</p>
					<p>
						<textarea name="Horringa_chamber_tx" cols="70" rows="3" id="Horringa_chamber_tx"></textarea>
							
						
					<p class="vraag_enquete">I consider the functioning of violinist Pavel Hůla:</p>
              <table>
                <tr>
                  <td><label><input name="Hula" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Hula_tx" cols="70" rows="3" id="Hula_tx"></textarea>
              </p>
              <p class="vraag_enquete">I consider the functioning of violinist/course leader Lucie Hůlová: </p>
              <table>
                <tr>
                  <td><label><input name="Hulova" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Hulova_tx" cols="70" rows="3" id="Hulova_tx"></textarea>
              <p class="vraag_enquete">I consider the functioning of violinist Štěpán Ježek:</p>
              <table>
                <tr>
                  <td><label><input name="Jezek" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Jezek_tx" cols="70" rows="3" id="Jezek_tx"></textarea>
              <p class="vraag_enquete">I consider the functioning of violist Jan Nykrýn:</p>
               <table>
                  <tr>
                     <td><label>
                        <input name="Nykryn" type="radio" value="0" checked>
                        no opinion</label></td>
                  </tr>
                  <tr>
                     <td><label>
...
<p class="vraag_enquete">I consider the functioning of clarinettist Ludmila Peterková:</p>
              <table>
                 <tr>
                  <td><label><input name="Peterkova" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>
                <textarea name="Peterkova_tx" cols="70" rows="3" id="Peterkova_tx"></textarea>
					...
					<p class="vraag_enquete">I consider the functioning of violist Jiří Pinkas:</p>
					<table>
						<tr>
							<td><label><input name="Pinkas" type="radio" value="0" checked>
								no opinion</label> </td>
						</tr>
						<tr>
							<td><label>
              ...
              <p class="vraag_enquete">I consider the functioning of cellist Martin Sedlák:</p>
              <table>
                <tr>
                  <td><label><input name="Sedlak" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Sedlak_tx" cols="70" rows="3" id="Sedlak_tx"></textarea>
              </p>

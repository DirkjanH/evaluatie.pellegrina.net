...
<div id="main">
	<!-- InstanceBeginEditable name="EditRegion1" -->
      <table id="evaluatie">
        <tr>
          <td><h1>Evaluation &quot;Viennese Masters&quot;            </h1>
...
<p class="standaard">
   <textarea name="Publiciteit_tx" cols="70" rows="3" id="Publiciteit_tx"></textarea> </p>
              ...
              <p>
                <textarea name="website_tx" cols="70" rows="3" id="website_tx"></textarea> </p>
              ...
              <p>
                <textarea name="Info_vooraf_tx" cols="70" rows="3" id="Info_vooraf_tx"></textarea> </p>
              <p class="vraag_enquete">This year the course duration was 10 days including a free day. I consider the optimal course duration:</p>
              <table>
                <tr>
                  <td width="491"><label>
              ...
              <p>
                <textarea name="duur_tx" cols="70" rows="3" id="duur_tx2"></textarea> </p>
              ...
              <p>
                <textarea name="prijs_tx" cols="70" rows="3" id="prijs_tx"></textarea> </p>
              ...
              <p>
                <textarea name="verschillen" cols="70" rows="6" id="verschillen"></textarea> </p>
              <hr>
              <h2>Content</h2>
              <div class="onzichtbaar">
                ...
                <p>The following can be improved:</p>
                <p>
                  <textarea name="inzeepdag_tx" cols="70" rows="3" id="inzeepdag_tx"></textarea> </p>
              </div>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="kamermuziek_tx" cols="70" rows="3" id="kamermuziek_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="coaching_kamermuziek_tx" cols="70" rows="3" id="coaching_kamermuziek_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="tutti_tx" cols="70" rows="3" id="tutti_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="coaching_tutti_tx" cols="70" rows="3" id="coaching_tutti_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="niveau_tx2" cols="70" rows="3" id="niveau_tx2"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="professionaliteit_tx" cols="70" rows="3" id="professionaliteit_tx"></textarea> </p>
              <hr>
              <h2>Organisation</h2>
              <p class="vraag_enquete">I stayed at:<span class="nadruk"> (the conservatoire hostel or accommodation you arranged yourself)</span></p>
               <p>
               ...
               <p>
                  <textarea name="accommodatie_tx" cols="70" rows="3" id="accommodatie_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="werkruimte_tx" cols="70" rows="3" id="werkruimte_tx"></textarea> </p>
              ...
              <p></p>
               ...
               <p>The following can be improved:</p>
               <p>
                  <textarea name="maaltijden_tx" cols="70" rows="3" id="maaltijden_tx"></textarea> </p>
               <div class="vraag">
                  ...
                  <p>
                     <textarea name="diner_vrij_tx" cols="70" rows="3" id="diner_vrij_tx"></textarea> </p>
               </div>
					<div class="onzichtbaar">
						...
						<p>Please give your opinion how this can be improved:</p>
						<p>
							<textarea name="maaltijdpas_tx" cols="70" rows="3" id="maaltijdpas_tx"></textarea> </p>
					</div>
               ...
               <p>The following can be improved:</p>
               <p>
                  <textarea name="info_terplekke_tx" cols="70" rows="3" id="info_terplekke_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="dagindeling_tx" cols="70" rows="3" id="dagindeling_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="zwaarte_tx" cols="70" rows="3" id="zwaarte_tx"></textarea> </p>
              ...
              <p>The following can be improved:</p>
              <p>
                <textarea name="groepsgrootte_tx" cols="70" rows="3" id="groepsgrootte_tx"></textarea> </p>
              <div class="vraag">
              	...
              	<p>
              		<textarea name="indiv_lessen_tx" cols="70" rows="3" id="indiv_lessen_tx"></textarea> </p>
              	</div>
              <div class="vraag">
              	...
              	<p>
              		<textarea name="solo_spelen_tx" cols="70" rows="3" id="solo_spelen_tx"></textarea> </p>
              	</div>
              <hr>
              <h2>Tutors</h2>
              ...
              <table>
                <tr>
                  <td width="436"><label><input name="Bernaskova3" type="radio" value="0" checked>
                    no opinion (didn't work with her)</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Bernaskova3_tx" cols="70" rows="3" id="Bernaskova3_tx"></textarea> </p>
              <p class="vraag_enquete">I consider the functioning of Petr Bernášek:</p>
              <table>
                <tr>
                  <td width="445"><label><input name="BernasekP" type="radio" value="0" checked>
                    no opinion (didn't work with him)</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="BernasekP_tx" cols="70" rows="3" id="BernasekP_tx"></textarea> </p>
              <p class="vraag_enquete">I consider the functioning of Dirkjan
           			 Horringa:</p>
              	<table>
                <tr>
                  <td width="324"><label><input name="Horringa3" type="radio" value="0" checked>
                    no opinion (didn't work with him)</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Horringa3_tx" cols="70" rows="3" id="Horringa3_tx"></textarea> </p>
              <p class="vraag_enquete">I consider the functioning of Pavel Hořejší:</p>
              <table>
                <tr>
                  <td width="365"><label><input name="Horejsi" type="radio" value="0" checked>
                    no opinion (didn't work with him)</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Horejsi_tx" cols="70" rows="3" id="Horejsi_tx"></textarea> </p>
              <p class="vraag_enquete">I consider the functioning of Libor Nováček:</p>
              <table>
                <tr>
                  <td width="372"><label><input name="Novacek" type="radio" value="0" checked>
                    no opinion (didn't work with him)</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Novacek_tx" cols="70" rows="3" id="Novacek_tx"></textarea> </p>
              <p class="vraag_enquete">I consider the functioning of Mitchell Sandler:</p>
              <table>
                <tr>
                  <td width="392"><label><input name="Sandler3" type="radio" value="0" checked>
                    no opinion (didn't work with him)</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Sandler3_tx" cols="70" rows="3" id="Sandler3_tx"></textarea> </p>
              <p class="vraag_enquete">I consider the functioning of Rudolf Sternadel:</p>
              <table>
                <tr>
                  <td width="401"><label><input name="Sternadel" type="radio" value="0" checked>
                    no opinion (didn't work with him)</label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="Sternadel_tx" cols="70" rows="3" id="Sternadel_tx"></textarea> </p></p>
              <div class="vraag">
              	...
              	<p>Remarks:</p>
              	<p>
              		<textarea name="Vlasankova_tx" cols="70" rows="3" id="Vlasankova_tx"></textarea> </p>
           		</div>
              ...
              <p>Remarks:</p>
              <p>
                <textarea name="ass_3_tx" cols="70" rows="3" id="ass_3_tx"></textarea> </p>
              <hr>
              ...
              <p>
                <textarea name="rep_wensen" cols="70" rows="3" id="rep_wensen"></textarea> </p>
              <p class="vraag_enquete">I have the following general remarks &amp; ideas:
              <p>
                <textarea name="alg_wensen" cols="70" rows="3" id="alg_wensen"></textarea> </p>
              ...
              <p>
                <textarea name="citaat" cols="70" rows="3" id="citaat"></textarea> </p>
              <hr>

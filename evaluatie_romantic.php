...
<title>Evaluatie zomercursus Stabat Mater</title>
...
<div id="main">
	<!-- InstanceBeginEditable name="EditRegion1" -->
      <table id="evaluatie">
        <tr>
          <td><h2>Evaluatie &quot;Dvořáks Stabat Mater&quot; </h2>
...
<p class="standaard">
   <textarea name="Publiciteit_tx" cols="70" rows="3" id="Publiciteit_tx"></textarea>
              ...
              <hr>
              <h2>Inhoud</h2>
               <p class="vraag_enquete">De voorbereidende repetitie op 12 juni
              ...
              <p class="vraag_enquete">Het programma met Dvořáks<em> Stabat Mater</em> is mij als volgt
                bevallen:</p>
              <table>
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">De voorbereiding van Dvořáks<em> Stabat Mater</em> vond ik:</p>
              <table>
                <tr>
                  <td><label>
...
<p class="vraag_enquete">De werkruimtes en instrumenten in het klooster vond ik:</p>
              <table width="200">
                <tr>
                  <td><label>
...
<p class="vraag_enquete">Ik vond het functioneren van Václav Vacek:</p>
              <table>
                <tr>
                  <td><label><input type="radio" name="Vacek" value="0" checked>
                    Geen mening (b.v. geen les van gehad)</label></td>
                </tr>
                <tr>
                  <td><label>

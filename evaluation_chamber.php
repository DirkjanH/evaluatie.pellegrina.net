...
<head>
   ...
   <meta name="theme-color" content="#ffffff">
	...
	<title>Evaluation reports chamber music course</title>
...
<p><strong>Enquiry forms received in total:<br>
	<?php echo $cursus; ?> van <?php echo $aantal_deelnemers[$i]; ?> = <?php echo $procent[$i]; ?>%</strong> <br>
</p>
...
<div>
	...
	<div id="T1">
		...
		<ul>
			<li><a onclick='openrapport( "rapport_gomez.php")'>Enrique Gomez</a></li>
			<li><a onclick='openrapport( "rapport_horringa1.php")'>Dirkjan Horringa</a></li>
			<li><a onclick='openrapport( "rapport_luckhardt.php")'>Cassandra Luckhardt</a></li>

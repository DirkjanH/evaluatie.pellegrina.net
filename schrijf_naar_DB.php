...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "evaluatie")) {
  // Blokkeer een tweede inzending vanuit dezelfde sessie gedurende 30 seconden.
  $huidigeTijd = time();
  $laatsteInzending = isset($_SESSION['laatste_evaluatie_indiening'])
    ? (int) $_SESSION['laatste_evaluatie_indiening']
    : 0;
  if ($laatsteInzending > 0 && ($huidigeTijd - $laatsteInzending) < 30) {
  ...
  $_SESSION['laatste_evaluatie_indiening'] = $huidigeTijd;

...
<div id="main">
	<!-- InstanceBeginEditable name="EditRegion1" -->
      <table id="evaluatie">
        <tr>
          <td><h2>Evaluatie Barok op Nieuw Sion 2021</h2>
            ...
            <form action="<?php echo $editFormAction; ?>" name="evaluatie" method="POST">
              ...
              <input name="cursus" type="hidden" id="cursus" value="52">
              ...
              <p class="vraag_enquete">Dit jaar duurde de cursus  5 dagen zonder een vrije dag, korter dan de andere jaren. Ik beschouw als optimale cursusduur:</p>
              <table width="100%">
                <tr>
                	<td><label><input type="hidden" name="duur" value="0">
							<input type="radio" name="duur" value="5">
5 dagen zonder een vrije dag <span class="nadruk">(zoals dit jaar)</span></label></td>
                	</tr>
                <tr>
                  <td><label>
...
<p class="vraag_enquete">Ik vind de prijs van het project:</p>
              ...
              <p class="vraag_enquete">Een project in Nederland in plaats van Tsjechië heeft zijn weerslag op het project, b.v. op de prijs, de reisduur en de accommodatie. <br>
Als ik mij afvraag of ik zal deelnemen aan een volgend project, is voor mij van doorslaggevende betekenis:</p>
              ...
              <p class="vraag_enquete">De muziekkeuze voor het programma <em>Bach & Buxtehude</em> is mij als volgt bevallen:</p>
              <table width="200">
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">De voorbereiding van het programma <em>Bach & Buxtehude</em> vond ik:</p>
              <table width="200">
                <tr>
                  <td><label>
              ...
              <hr>
              <h2>Organisatie</h2>
              <p class="vraag_enquete">Ik verbleef in:<span class="nadruk"> (het gastenverblijf, de camping of accommodatie die je zelf had geregeld)</span></p>
               <p>
...
<p class="vraag_enquete">Ontbijt, lunch en avondmaaltijd vond ik:</p>
              <table width="200">
                <tr>
                  <td><label>
              ...
              <div class="vraag onzichtbaar">
                 ...
                 <table>
                    <tr>
                      <td><label><input type="radio" name="maaltijdpas" value="0"> 
              ...
              <p class="vraag_enquete">Ik vond het functioneren van Antoinette Lohmann:</p>
              <table>
                <tr>
                  <td><label><input type="radio" name="Lohmann" value="0" checked>
                    Geen mening (b.v. geen les van gehad) </label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Lohmann" value="5">
                      zeer goed</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Lohmann" value="4">
                      goed</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Lohmann" value="3">
                      redelijk</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Lohmann" value="2">
                    slecht</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Lohmann" value="1">
                      zeer slecht</label></td>
                </tr>
              </table>
              <p>Opmerkingen:</p>
              <p>
                <textarea name="Lohmann_tx" cols="70" rows="3" id="Lohmann_tx"></textarea>
              ...
              <p class="vraag_enquete">Ik vond het functioneren van Marta Semkiw:</p>
              <table>
                <tr>
                  <td><label><input type="radio" name="Semkiw" value="0" checked>
                    Geen mening (b.v. geen les van gehad) </label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Semkiw" value="5">
                    zeer goed</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Semkiw" value="4">
                    goed</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Semkiw" value="3">
                    redelijk</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Semkiw" value="2">
                  slecht</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Semkiw" value="1">
                    zeer slecht</label></td>
                </tr>
              </table>
              <p>Opmerkingen:</p>
              <p>
                <textarea name="Semkiw_tx" cols="70" rows="3" id="Semkiw_tx"></textarea>
              </p>
              <p class="vraag_enquete">Ik vond het functioneren van Marco Vitale:</p>
              <table>
                <tr>
                  <td><label><input type="radio" name="Vitale" value="0" checked>
                    Geen mening (b.v. geen les van gehad) </label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Vitale" value="5">
                      zeer goed</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Vitale" value="4">
                      goed</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Vitale" value="3">
                      redelijk</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Vitale" value="2">
                    slecht</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Vitale" value="1">
                      zeer slecht</label></td>
                </tr>
              </table>
              <p>Opmerkingen:</p>
              <p>
              <textarea name="Vitale_tx" cols="70" rows="3" id="Vitale_tx"></textarea>              
              <p class="vraag_enquete">Ik vond het functioneren van Jurgen van der Ent als assistent:</p>
              <table width="200">
                <tr>
                  <td><label>

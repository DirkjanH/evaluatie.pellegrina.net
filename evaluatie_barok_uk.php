...
<div id="main">
	<!-- InstanceBeginEditable name="EditRegion1" -->
      <table id="evaluatie">
        <tr>
          <td><h2>Evaluation &quot;Purcell's Chapel Royal&quot;</h2>
            ...
            <form action="<?php echo $editFormAction; ?>" name="evaluatie" method="POST">
              ...
              <input name="cursus" type="hidden" id="cursus" value="44">
              ...
              <p class="vraag_enquete">This year the course duration was 8 days without a free day, shorter than last year. I consider the optimal course duration:</p>
              <table>
                <tr>
                  <td width="491"><label>
                      <input type="hidden" name="duur" value="0">
                      <input type="radio" name="duur" value="7">
                      7 days without a free day </label></td>
                </tr>
                <tr>
                	<td><label><input type="radio" name="duur" value="8">
8 days without a free day <span class="nadruk">(like this year)</span></label></td>
                	</tr>
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">The programming of the <em>Purcell's Chapel Royal</em> concert I consider: </p>
              <table width="200">
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">The rehearsals for the <em>Purcell's Chapel Royal</em> concert I consider:</p>
              <table width="200">
                <tr>
                  <td><label>
...
<p class="vraag_enquete">The classrooms and the instruments at the monastery I consider:</p>
 ...
 <hr>
              ...
              <p class="vraag_enquete">I consider the functioning of Enrique Gomez:</p>
              <table>
                <tr>
                  <td><label><input name="Gomez" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Gomez" value="5">
                      excellent</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Gomez" value="4">
                      good</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Gomez" value="3">
                      adequate</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Gomez" value="2">
                    weak</label></td>
                </tr>
                <tr>
                  <td><label>
                      <input type="radio" name="Gomez" value="1">
                      inadequate</label></td>
                </tr>
              </table>
              <p>Remarks:</p>
              <p>
                <textarea name="Gomez_tx" cols="70" rows="3" id="Gomez_tx"></textarea>
              ...
              <p class="vraag_enquete">I consider the functioning of Cassandra Luckhardt:</p>
              <table>
                <tr>
                  <td><label><input name="Luckhardt" type="radio" value="0" checked>
                    no opinion</label> </td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Luckhardt" value="5">
                    excellent</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Luckhardt" value="4">
                    good</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Luckhardt" value="3">
                    adequate</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Luckhardt" value="2">
                  weak</label></td>
                </tr>
                <tr>
                  <td><label>
                    <input type="radio" name="Luckhardt" value="1">
                    inadequate</label></td>
                </tr>
              </table>
              <p>Remarks:</p>
              <p>
                <textarea name="Luckhardt_tx" cols="70" rows="3" id="Luckhardt_tx"></textarea>
              ...
              <p class="vraag_enquete">I consider the functioning of Marco
                Vitale:</p>
              <table>
                <tr>
                  <td><label><input name="Vitale" type="radio" value="0" checked>
                    no opinion </label></td>
                </tr>
                <tr>
                  <td><label>
              ...
              <p class="vraag_enquete">I consider the functioning of  the assistants
                Karel and both Jana's:</p>
              <table width="200">
                <tr>
                  <td><label>
